...
def index():
    ...
    return render_template('index4.html', nf_status=nf_status, connected_nodes=connected_nodes, connected_ues=connected_ues)
...
if __name__ == "__main__":
    app.run(debug=True, host='0.0.0.0', port=5001)  # Running on a different port to avoid conflict
